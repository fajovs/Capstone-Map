...
export function SignupForm({ ...props }: SignupFormProps) {
  ...
  try {
    ...
    if (loginError) {
      setStatus("Account created but login failed: " + loginError.message);
      return;
    }
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <FieldGroup>
            ...
            <Field>
              ...
              <FieldDescription>We'll use this to contact you. We will not share your email.</FieldDescription>
            ...
            <Field>
              <Button type="submit" disabled={isLoading}>{isLoading ? <Spinner className="size-4" /> : "Create Account"}</Button>
